...
namespace Proyecto_Veterinaria.Controllers
{
    public class MedicamentoesController : Controller
    {
        ...
        public MedicamentoesController(VeterinariaDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MedicamentoID,NombreMedicamento,Descripcion")] Medicamento medicamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MedicamentoID,NombreMedicamento,Descripcion")] Medicamento medicamento)
        {
