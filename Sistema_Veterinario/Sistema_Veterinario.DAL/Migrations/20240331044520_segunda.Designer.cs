...
namespace Sistema_Veterinario.DAL.Migrations
{
    ...
    [Migration("20240331044520_segunda")]
            ...
            modelBuilder.Entity("Sistema_Veterinario.DAL.Mascota", b =>
                {
                    ...
                    b.Property<int>("MascotaUsuarioAccionID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MascotaUsuarioAccionID");
            ...
            modelBuilder.Entity("Sistema_Veterinario.DAL.MascotaUsuarioAccion", b =>
                {
                    ...
                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MascotaUsuarioAccionID"));
                    ...
                    b.HasKey("MascotaUsuarioAccionID");
            ...
            modelBuilder.Entity("Sistema_Veterinario.DAL.Mascota", b =>
                {
                    ...
                    b.HasOne("Sistema_Veterinario.DAL.MascotaUsuarioAccion", "MascotaUsuarioAccion")
                        .WithMany()
                        .HasForeignKey("MascotaUsuarioAccionID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("MascotaUsuarioAccion");
