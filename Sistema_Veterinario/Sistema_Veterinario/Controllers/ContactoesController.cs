...
namespace Sistema_Veterinario.Controllers
{
    public class ContactoesController : Controller
    {
        ...
        public ContactoesController(Sistema_VeterinarioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ContactoId,CorreoElectronico,Telefono")] Contacto contacto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ContactoId,CorreoElectronico,Telefono")] Contacto contacto)
        {
