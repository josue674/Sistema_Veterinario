...
namespace Sistema_Veterinario.Controllers
{
    public class DesparasitacionVacunasController : Controller
    {
        ...
        public DesparasitacionVacunasController(Sistema_VeterinarioDbContext context)
        {
            _context = context;
        }
        ...
        {
            var sistema_VeterinarioDbContext = _context.DesparasitacionVacunas.Include(d => d.Mascota);
        ...
        public async Task<IActionResult> Create([Bind("DesparasitacionVacunaID,MascotaID,Tipo,Fecha,Producto")] DesparasitacionVacuna desparasitacionVacuna)
        {
            ...
            ViewData["MascotaID"] = new SelectList(_context.Mascotas, "MascotaID", "Genero", desparasitacionVacuna.MascotaID);
            return View(desparasitacionVacuna);
        }
