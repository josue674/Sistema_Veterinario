...
namespace Sistema_Veterinario.Controllers
{
    public class PadecimientoesController : Controller
    {
        ...
        public PadecimientoesController(Sistema_VeterinarioDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PadecimientoId,NombrePadecimiento")] Padecimiento padecimiento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PadecimientoId,NombrePadecimiento")] Padecimiento padecimiento)
        {
