...
namespace Sistema_Veterinario.Controllers
{
    public class PadecimientoesController : Controller
    {
        ...
        {
            var sistema_VeterinarioDbContext = _context.Padecimientos.Include(p => p.Mascota);
        ...
        public async Task<IActionResult> Create([Bind("PadecimientoID,MascotaID,Descripcion")] Padecimiento padecimiento)
        {
            ...
            ViewData["MascotaID"] = new SelectList(_context.Mascotas, "MascotaID", "Genero", padecimiento.MascotaID);
            return View(padecimiento);
        }
